...
const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      'Copy the folder onto the phone first: internal storage or an SD card, anywhere the file picker can see it. Tap Pick a folder and choose it. The app reads what is in there and lists it: search by title or composer, narrow by level or style, or tick “rated 4+ by 5+ people”.',
