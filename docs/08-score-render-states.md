...
| §5.1 the read-ahead on the 780-bar piece | the next bar arrived a second or more after the crossing on a tablet — each bar of the Scherzo is the better part of a second to engrave on this laptop | **measured, not fixed** — the corpus allows the capped piece three seconds and records the lag a step; the other nine pieces read ahead within a second, mostly within 25 ms |
