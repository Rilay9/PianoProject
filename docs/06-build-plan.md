...
| **P21b–P21e — the tour rounds**: three rounds of the reviewer reading the tour's pictures and a bar-by-bar sequence, each round a fix list (`prompts/P21b-tour-fixes.md`, `P21c-read-ahead-and-listen.md`, `P21d-landscape-and-leftovers.md`, `P21e-round-three.md`); P21e's second half and a fourth round on the state machines — stopping is not finishing, a lap moves the cursor, the crossing off the input path, the whole-song sequence on four form factors — were done by the reviewer (`docs/decisions/2026-09-08-p21e-round-three.md`) | those four files | no | laptop |
