...
- [ ] **FALSE** `content/lessons/ragtime.7.md:16` — "a genuine leap: a tenth or more down to a single note, back up to a chord"
...
- [ ] **FALSE** `content/lessons/ragtime.7.md:17` — "back up to a chord, twice a bar, at tempo"
...
- [ ] **FALSE** `content/lessons/ragtime.7.md:19` — "the practice is the same as it was at Stage 5 and will be at Stage 8: left hand alone"
...
- [ ] **FALSE** `content/lessons/ragtime.7.md:36` — "a three-note figure repeats against a four-beat bar, so the accent moves each time and only comes back round after three bars"
...
- [ ] **WRONG-COUNT** `content/lessons/ragtime.7.md:42` — "The library has the scholarly Humdrum edition and a MuseScore transcription."
...
- [ ] **FALSE** `content/lessons/technique.7.md:12` — "Everything on this rung is one hand doing two things at once."
...
- [ ] **FALSE** `content/lessons/technique.7.md:16` — "Both fingers are printed, as the standard three-group cycle: 1-3, 2-4, 3-5 and round again"
...
- [ ] **FALSE** `content/lessons/technique.7.md:37` — "This exercise is scored on the pedal *value* rather than its timing: the app wants it somewhere in the middle of its travel"
...
- [ ] **FALSE** `content/lessons/technique.7.md:38` — "and will tell you if your pedal only ever reports 0 or 127"
...
- [ ] **FALSE** `content/lessons/technique.7.md:42` — "Czerny Op. 299 No. 5, No. 8 and No. 10, the faster ones: scales in both hands, broken chords across the keyboard, and the double-note figures"
...
- [ ] **FALSE** `content/lessons/technique.7.md:47` — "*Duet* will hold one of them: choose the hand playing the three, let the app play the two"
...
- [ ] **FALSE** `content/lessons/jazz.7.md:35` — "The tenth on beat three is what makes it stride, and it is the leap you will miss."
...
- [ ] **JUDGEMENT** `content/lessons/jazz.7.md:24` — "it is the sound of modal jazz and of most film music written since 1960"
  ...
  - Evidence: none possible from the repository.
- [ ] **FALSE** `content/lessons/jazz.7.md:54` — "The copy in the Library is shortened — one A section before the bridge"
...
- [ ] **FALSE** `content/lessons/jazz.7.md:61` — "**Tools for this rung.** The lab's typed numerals take flats and sevenths, so `ii7 V7 I` and `ii7 ♭II7 I` can be built as two loops"
...
- [ ] **FALSE** `content/lessons/blues.7.md:12` — "Two leaps a bar, both of them downward-then-upward"
...
- [ ] **FALSE** `content/lessons/blues.7.md:32` — "Three, and all of them are a left hand that never stops."
...
- [ ] **FALSE** `content/lessons/blues.7.md:34` — "with the turnaround written out, so you can see the two bars rather than invent them"
...
- [ ] **FALSE** `content/lessons/blues.7.md:44` — "**Tools for this rung.** … *Rhythm only* takes them apart"
...
- [ ] **FALSE** `content/lessons/chords-pop.7.md:34` — "*Fix You* and *Blinding Lights* are sus and add9 colour over a bass that barely moves"
...
- [ ] **FALSE** `content/lessons/chords-pop.7.md:37` — "*Wake Me Up* is the loop with a syncopated left hand under it"
...
- [ ] **FALSE** `content/lessons/chords-pop.7.md:48` — "*Hear it* sounds the ninth chord, so C, Cadd9 and C9 can be compared in one breath"
...
- [ ] **STALE** `content/lessons/chords-pop.7.md:47` — "**Tools for this rung.**" (the paragraph describes the drill's buttons)
...
- [ ] **FALSE** `content/lessons/theory.7.md:29` — "the app names one and says so, and you should trust your ear over it"
...
- [ ] **FALSE** `content/lessons/theory.7.md:40` — "**Tools for this rung.** The accompaniment lab reads `V/V` as a numeral"
...
- [ ] **WRONG-COUNT** `content/lessons/rock.7.md:9` — "It is the last of the five things the overview named"
...
- [ ] **FALSE** `content/lessons/rock.7.md:33` — "The shaping exercises are four bars of one line getting louder and then quieter"
...
- [ ] **FALSE** `content/lessons/rock.7.md:39` — "Three options, all bundled"
...
- [ ] **FALSE** `content/lessons/rock.7.md:40` — "one sixteen-bar idea repeated while the register widens and the tempo grows"
...
- [ ] **FALSE** `content/lessons/classical.8.md:58` — "The method above is on the score screen … the raising and the dropping back happen while your attention stays on the hand"
...
- [ ] **FALSE** `content/lessons/classical.8.md:58` — "loop two beats of the étude, switch the *Ladder* on"
...
- [ ] **FALSE** `content/lessons/ragtime.8.md:18` — "the secondary rag — three-note groups across a four-beat bar — turns up in whole strains"
...
- [ ] **FALSE** `content/lessons/ragtime.8.md:48` — "Joplin's *Euphonic Sounds*, which is not in the public-domain edition this library was built from"
...
- [ ] **FALSE** `content/lessons/ragtime.8.md:56` — "**Tools for this rung.** … Play a strain in *Rhythm only*"
...
- [ ] **FALSE** `content/lessons/technique.8.md:35` — "**Tools for this rung.** Moving it up a few beats at a time is what the *Ladder* does with a loop set"
...
- [ ] **FALSE** `content/lessons/technique.8.md:37` — "Loop one octave while you are finding the tempo"
...
- [ ] **STALE** `content/lessons/blues.8.md:36` — "it is the same file you met a rung ago"
...
- [ ] **FALSE** `content/lessons/blues.8.md:45` — "Typed numerals carry their sevenths, so `I7 IV7 V7` set in E flat builds the whole form in the new key"
...
- [ ] **FALSE** `content/lessons/blues.8.md:45` — "Typed numerals …" (as reached from this rung)
...
- [ ] **FALSE** `content/lessons/chords-pop.8.md:45` — "Build the song's changes once as numerals, move the key down a tone and start the loop"
...
- [ ] **FALSE** `content/lessons/improv.8.md:37` — "A secondary dominant is a numeral the accompaniment lab will read, so an approach chord can be typed in … Build your three versions there"
...
- [ ] **FALSE** `content/lessons/classical.9.md:39` — "Six options, and they are all long"
...
- [ ] **FALSE** `content/lessons/jazz.9.md:15` — "The same 32 bars each time"
...
- [ ] **FALSE** `content/lessons/jazz.9.md:34` — "*Lullaby of Birdland* for a fast tune made of ii–V–Is"
...
- [ ] **FALSE** `content/lessons/jazz.9.md:36` — "*Linus and Lucy* for a left-hand ostinato that never stops"
...
- [ ] **FALSE** `content/lessons/jazz.9.md:45` — "*Blind* takes the lead sheet away and changes nothing else about the run"
...
- [ ] **WRONG-COUNT** `content/lessons/blues.9.md:12` — "This rung is the point of the other four."
...
- [ ] **FALSE** `content/lessons/chords-pop.9.md:31` — "play it as written once, then strip it back to its chord symbols and build your own"
...
- [ ] **FALSE** `content/lessons/chords-pop.9.md:34` — "*Rolling Girl* and *Apex of the World* are the fast ones"
...
- [ ] **FALSE** `content/lessons/chords-pop.9.md:44` — "Put the chart in the lab, start it, and try three different left hands over the same sixteen bars"
