...
- [ ] **FALSE** `content/lessons/3.2.md:35` — "I–IV–V7 drills in C, G and F, both root position and the smooth version"
...
- [ ] **FALSE** `content/lessons/3.2.md:44` — "The accompaniment lab under Library will build this rung in either key."
...
- [ ] **FALSE** `content/lessons/3.3.md:33` — "every cadence turns to E7 with its G sharp"
...
- [ ] **FALSE** `content/lessons/3.3.md:36` — "A harmonic minor scale hands separately"
...
- [ ] **FALSE** `content/lessons/3.3.md:43` — "The lab takes numerals typed by hand, sevenths included, so `i iv V7 i` in A minor gives you these changes"
...
- [ ] **FALSE** `content/lessons/3.4.md:46` — "The daily read on *Today* moves up with you, and at this stage it is the two-hand phrase"
...
- [ ] **FALSE** `content/lessons/3.4.md:47` — "over the wider range: the landmarks above"
...
- [ ] **FALSE** `content/lessons/3.6.md:38` — "then the same drills with a right-hand scale over the top"
...
- [ ] **FALSE** `content/lessons/3.6.md:45` — "These three patterns are the ones the accompaniment lab writes"
...
- [ ] **FALSE** `content/lessons/3.6.md:47` — "pick the alberti or the waltz bass and *Read it*"
...
- [ ] **FALSE** `content/lessons/classical.3.md:42` — "Six options, all dances from the notebooks the Bach and Mozart children learned from"
...
- [ ] **FALSE** `content/lessons/classical.3.md:46` — "Beethoven's *Écossaise* in G for a quick 2/4 with hand shifts"
...
- [ ] **FALSE** `content/lessons/classical.3.md:38` — "The drill on the technique track at Stage 5 is deliberately the other one, the stroked sign going below"
...
- [ ] **FALSE** `content/lessons/chords-pop.3.md:57` — "because the key is the one thing that preset leaves you"
...
- [ ] **FALSE** `content/lessons/blues.3.md:36` — "*St. Louis Blues* is the famous one and is the longest."
...
- [ ] **FALSE** `content/lessons/blues.3.md:44` — "You are already playing pieces built on it"
...
- [ ] **WRONG-COUNT** `content/lessons/blues.3.md:50` — "**Tools for this rung.** Three."
...
- [ ] **STALE** `content/lessons/theory.3.md:39` — "the progression drill arrives on the Stage 5 rung of this track"
...
- [ ] **FALSE** `content/lessons/theory.3.md:58` — "and a chain of five notes played back in Simon"
...
- [ ] **FALSE** `content/lessons/improv.3.md:46` — "The loop you play over is the accompaniment lab's *Jam it*: four bars of C, two of F, two of G"
...
- [ ] **FALSE** `content/lessons/hymns.md:55` — "Switch *Duet* on with the left hand chosen and soprano and alto arrive over the tenor and bass you are playing"
...
- [ ] **FALSE** `content/lessons/hymns.md:46` — "and under *Hymns & gospel* in the Library"
...
- [ ] **FALSE** `content/lessons/rock.overview.md:40` — "The easy *Canon in D* is above this rung"
...
- [ ] **FALSE** `content/lessons/latin.3.md:39` — "*Play it as a duet* lets the app take one hand while you hold the other, which is the easiest way into the two-part clave"
...
- [ ] **FALSE** `content/lessons/latin.3.md:18` — "The exercises here are written on a single line with nothing to read but the rhythm"
...
- [ ] **UNOFFERED** `content/lessons/4.1.md:35` — "Each key: contrary motion one octave, then similar motion one octave, then two"
...
- [ ] **UNOFFERED** `content/lessons/4.2.md:40` — "contrary motion first as before"
...
- [ ] **FALSE** `content/lessons/4.3.md:41` — "Then a piece that uses broken chords throughout — the easy *Canon in D*"
...
- [ ] **FALSE** `content/lessons/4.3.md:48` — "Thirty symbols at three seconds each leaves no room to work one out"
...
- [ ] **UNOFFERED** `content/lessons/4.4.md:40` — "Hanon 1 to 10 from the generator"
...
- [ ] **STALE** `content/lessons/4.5.md:12` — "Every time signature so far has divided the beat in two."
...
- [ ] **FALSE** `content/lessons/4.5.md:19` — "*Row Row Row Your Boat* and *Greensleeves in 6/8* are both classic examples — long-short, long-short."
...
- [ ] **FALSE** `content/lessons/4.5.md:29` — "This is where the blues track begins."
...
- [ ] **FALSE** `content/lessons/4.5.md:45` — "*Rhythm only* measures each strike against the two dotted-quarter beats"
