...
- [ ] **STALE** `content/lessons/4.6.md:12` — "The end of the core path."
...
- [ ] **FALSE** `content/lessons/4.6.md:52` — "**Tools for this rung.** Reading ahead needs music you have not met, and the daily read on *Today* is exactly that"
...
- [ ] **FALSE** `content/lessons/4.6.md:43` — "**Performance mode** scores you with no stopping and no second attempts"
...
- [ ] **UNOFFERED** `content/lessons/4.6.md:47` — "one of the easy *Für Elise* settings works well"
...
- [ ] **FALSE** `content/lessons/4.7.md:39` — "that is the app checking you have the notes before it takes them away"
...
- [ ] **FALSE** `content/lessons/4.7.md:40` — "the score disappears, the keyboard strip and the cursor stay"
...
- [ ] **FALSE** `content/lessons/4.7.md:43` — "the rung wants 90 % of what you managed with the page"
...
- [ ] **FALSE** `content/lessons/classical.4.md:46` — "and a Gurlitt study with the two side by side"
...
- [ ] **FALSE** `content/lessons/classical.4.md:43` — "two of the child Mozart's minuets, K. 1e in G and K. 1f in C"
...
- [ ] **WRONG-COUNT** `content/lessons/classical.4.shelf.md:23` — "three Chopin *Préludes* and a waltz"
...
- [ ] **FALSE** `content/lessons/classical.4.shelf.md:20` — "up to the Chopin nocturnes, … at Stage 8"
...
- [ ] **FALSE** `content/lessons/classical.4.shelf.md:21` — "the Handel–Halvorsen *Passacaglia* at Stage 8"
...
- [ ] **FALSE** `content/lessons/classical.4.shelf.md:24` — "Elgar's *Salut d'amour* and *Nimrod*, Puccini's *O mio babbino caro*" (listed as the shelf common to every build, before "on the personal build only")
...
- [ ] **WRONG-COUNT** `content/lessons/classical.4.shelf.md:26` — "the film and game pieces the owner asked for by name: Einaudi, Zimmer, Sakamoto, Uematsu, Djawadi, Hurwitz, Glass, de Senneville, Clayderman"
...
- [ ] **FALSE** `content/lessons/classical.4.shelf.md:28` — "The Library's Classical filter holds what came off this shelf: … and every second edition."
...
- [ ] **FALSE** `content/lessons/classical.4.shelf.md:34` — "the public build shows the row and says where to get the score"
...
- [ ] **FALSE** `content/lessons/classical.4.shelf.md:35` — "Anything else you love — Yiruma, Tiersen, Hisaishi — buy the MusicXML or transcribe it and import it"
...
- [ ] **FALSE** `content/lessons/chords-pop.4.md:41` — "*Hallelujah*, in its easy setting, is the four-chord song itself"
...
- [ ] **FALSE** `content/lessons/chords-pop.4.md:42` — "*Alexander's Ragtime Band* is the busiest chart here, putting vi, ii and a chord borrowed from another key in a row"
...
- [ ] **FALSE** `content/lessons/blues.4.md:56` — "Shuffle is a claim about timing, and the app will check it: in *Rhythm only* the long-short pair is judged where it falls and nowhere else"
...
- [ ] **STALE** `content/lessons/blues.4.md:56` — "**Tools for this rung.**" (the paragraph names only *Rhythm only*)
...
- [ ] **FALSE** `content/lessons/theory.4.md:41` — "**Melodic dictation.** The app plays two bars; you play them back."
...
- [ ] **FALSE** `content/lessons/theory.4.md:48` — "Melodic dictation asks you to hold two bars before you can play any of them"
...
- [ ] **UNOFFERED** `content/lessons/theory.4.md:56` — "triad inversions identified by their bass"
...
- [ ] **FALSE** `content/lessons/improv.4.md:25` — "The app plays a two-bar call; you play a two-bar answer."
...
- [ ] **FALSE** `content/lessons/improv.4.md:48` — "**Tools for this rung.** Set I–vi–IV–V in the lab and start it"
...
- [ ] **FALSE** `content/lessons/improv.4.md:22` — "the four-chord one moves twice as often"
...
- [ ] **FALSE** `content/lessons/improv.4.md:49` — "one chord a bar is twice the work of the last rung's loop"
...
- [ ] **STALE** `content/lessons/jam.md:18` — "The twelve-bar shuffles on this rung are written in C, F and G"
...
- [ ] **FALSE** `content/lessons/jam.md:47` — "**The form tracker.** PianoPath's chord-chart view shows where you are in the form and which chorus you are on"
...
- [ ] **FALSE** `content/lessons/technique.4.md:38` — "The app scores these on how long you actually hold each key rather than on which notes you played"
...
- [ ] **FALSE** `content/lessons/technique.4.md:22` — "The fingering printed on each exercise is the standard one"
...
- [ ] **FALSE** `content/lessons/technique.4.md:25` — "**Contrary motion** is easier than it sounds … both thumbs move at the same time, so the hands mirror each other" (with line 27 "The two-octave C major here is the one to start on")
...
- [ ] **FALSE** `content/lessons/technique.4.md:47` — "the same finger work as the exercises above with a tune over it" (No. 2)
...
- [ ] **FALSE** `content/lessons/rock.4.md:21` — "The exercises put a two-note figure in the right hand over a bass that never moves."
...
- [ ] **FALSE** `content/lessons/rock.4.md:8` — "The rung before this one taught the reduction … and named the textures. This is the first of them under your hands"
...
- [ ] **FALSE** `content/lessons/rock.4.md:34` — "*Play it as a duet* takes one hand away: let the app hold the tune while you drill the left hand alone, then swap."
...
- [ ] **FALSE** `content/lessons/classical.5.md:23` — "Clementi's Op. 36 No. 1, all three movements"
...
- [ ] **FALSE** `content/lessons/classical.5.md:33` — "The Alberti exercise on this rung is that figure with nothing on top"
...
- [ ] **FALSE** `content/lessons/classical.5.md:40` — "The written-out drill is on the technique track a stage later" (trills and mordents)
...
- [ ] **FALSE** `content/lessons/classical.5.md:60` — "It will hold a tempo until a pass has nothing wrong in it"
...
- [ ] **FALSE** `content/lessons/chords-pop.5.md:51` — "Type `ii7 V7 I` into the lab, choose a broken left hand, and *Read it* hands you the seventh voicings"
...
- [ ] **UNOFFERED** `content/lessons/chords-pop.5.md:28` — "C–E–G–D with the added note on top, which is what the drill plays … Learn the drill's"
...
- [ ] **FALSE** `content/lessons/chords-pop.5.md:41` — "*Greensleeves* in 6/8 with its jazzier chords"
...
- [ ] **UNOFFERED** `content/lessons/blues.5.md:15` — "The classic move is a chromatic line descending from the tonic to the fifth … ending on the V7 … Learn two of them and use them alternately"
...
- [ ] **FALSE** `content/lessons/blues.5.md:40` — "**Walking bass.** … one note per beat moving mostly by step through the chord tones"
...
- [ ] **FALSE** `content/lessons/jazz.5.md:22` — "What is left — **root, third and seventh** — is a shell: three notes … That is how the exercise on this rung writes it."
...
- [ ] **UNOFFERED** `content/lessons/jazz.5.md:34` — "Learn ii–V–I in C, F, B flat and G, with the shells barely moving."
...
- [ ] **FALSE** `content/lessons/jazz.5.md:53` — "Swing is an accent and a placing, and *Rhythm only* will check both with the notes set aside"
...
- [ ] **STALE** `content/lessons/jazz.5.md:53` — "**Tools for this rung.**" (names only *Rhythm only*)
...
- [ ] **FALSE** `content/lessons/ragtime.5.md:40` — "*The Entertainer* is the only actual rag on the rung"
...
- [ ] **FALSE** `content/lessons/ragtime.5.md:54` — "*Rhythm only* … judges the moment of each strike … so anything that comes out swung is marked late before your ear has caught it"
...
- [ ] **STALE** `content/lessons/ragtime.5.md:54` — "**Tools for this rung.**" (names only *Rhythm only*)
