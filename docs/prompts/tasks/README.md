...
| **C4d** | The contract over composed recipes the reader can reach, unreliable compositions declared; the hands-together opportunity as coordination; the four reruns (the C4.5 review's two P1s) | build | after the C4c chain |
