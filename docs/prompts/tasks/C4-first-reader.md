...
6. **Nothing else adapts.** The technique, review, new and repertoire slots keep their rules (C6). The Skills screen keeps reading `skillsStore` (C7). The swap sheet is untouched.
