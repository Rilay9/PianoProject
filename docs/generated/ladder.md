...
| 3 | `holiday.3` | 4 | 8 | 2.9–3.5 | God Rest Ye Merry, Gentlemen (2.9), Jingle Bells (chorus, in G major with block chords) (3.2), Joy to the World (3.2), The First Noel (3.3), Hark! The Herald Angels Sing (3.3), O Christmas Tree (3.4), … and 2 more |
...
| 8 | `chords-pop.8` *(song-optional)* | 5 | 6 | 5.4–8.3 | Silhouette (6.7), Levi's Choice, from Attack on Titan (6.8), All I Want (6.9), Isabella's Lullaby, from The Promised Neverland (7.1), Undertale, from Undertale (7.8), If I Had a Chicken (7.8) |
| 9 | `chords-pop.9` *(song-optional)* | 6 | 6 | 5.3–8.4 | Falling (7.2), Piano Man (7.4), Apex of the World, from Fire Emblem: Three Houses (7.4), Mr. Blue Sky (7.5), Le Festin (7.6), Rolling Girl (7.7) |
...
| stage | rung | exercises | songs | level | options |
|---|---|---:|---:|---|---|
| 3 | `theory.3` *(song-optional)* | 4 | 0 | 2.0–3.3 | — |
| 4 | `theory.4` *(song-optional)* | 4 | 0 | 4.3–5.0 | — |
...
| 9 | `jazz.9` *(song-optional)* | 5 | 6 | 5.2–8.4 | When the Saints Go Marching In (jazz) (5.2), Stardust (1927) (6.0), Take Five (6.6), Ain't Misbehavin' (6.9), Lullaby of Birdland (6.9), Linus and Lucy (8.3) |
...
| `song.classical.tango-la-cumparsita-piano-solo-tutorial-parte-a.pdmx` | La Cumparsita (part A) | 5.1 | The composition is unknown; the owner's own build carries it (`00` D23). |
...
| `song.folk.10000-reasons-matt-redman.pdmx` | 10,000 Reasons | 6.2 | The composition is unknown; the owner's own build carries it (`00` D23). |
...
| `song.folk.before-you-go-lewis-capaldi.pdmx` | Before You Go | 4.7 | The composition is unknown; the owner's own build carries it (`00` D23). |
...
| `song.folk.insensatez-how-insensitive-jobim.pdmx` | Insensatez (How Insensitive) | 3.0 | The composition is unknown; the owner's own build carries it (`00` D23). |
...
| `song.folk.john-denver-annie-s-song.pdmx` | Annie's Song | 6.4 | The composition is unknown; the owner's own build carries it (`00` D23). |
| `song.folk.just-a-closer-walk-with-thee-easy-piano.pdmx` | Just a Closer Walk with Thee | 4.0 | The composition is unknown; the owner's own build carries it (`00` D23). |
