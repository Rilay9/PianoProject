"""
A twelve-bar blues in E: shuffle bass under seventh chords.
...
PIANOPATH = {
    "id": "exercise.blues.twelve-bar-shuffle.e",
    "title": "Twelve-bar blues shuffle in E",
    "level": 4.1,
    "hands": "both",
...
def build() -> stream.Score:
    return build_twelve_bar("E", PIANOPATH["tempoBpm"])
