"""
A twelve-bar blues in A: shuffle bass under seventh chords.
...
PIANOPATH = {
    "id": "exercise.blues.twelve-bar-shuffle.a",
    "title": "Twelve-bar blues shuffle in A",
    "level": 4.1,
    "hands": "both",
...
def build() -> stream.Score:
    return build_twelve_bar("A", PIANOPATH["tempoBpm"])
